...
import com.efratec.algamoney.api.service.PessoaService;
...
public class PessoaResource {
	...
	@PostMapping
	@PreAuthorize("hasAuthority('ROLE_CADASTRAR_PESSOA') and #auth2.hasScope('writer')")
	...
	@GetMapping("/{codigo}")
	@PreAuthorize("hasAuthority('ROLE_PESQUISA_PESSOA') and #auth2.hasScope('read')")
